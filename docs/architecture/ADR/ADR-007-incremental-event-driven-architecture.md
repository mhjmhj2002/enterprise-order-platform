...
Aceito para planejamento da Sprint 2.
...
- Kafka, producer e consumer ainda não estão implementados.
- O resultado funcional do consumidor ainda requer refinamento com Engenharia.
