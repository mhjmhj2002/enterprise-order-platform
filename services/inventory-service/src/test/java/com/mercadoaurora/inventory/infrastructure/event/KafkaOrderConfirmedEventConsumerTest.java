...
class KafkaOrderConfirmedEventConsumerTest {
    @Mock
    private OrderConfirmationRecognizer useCase;
    ...
    void shouldRecognizeApprovedEnvelopeWithKafkaTraceability() {
        ...
        new KafkaOrderConfirmedEventConsumer(useCase).consume(record);
    ...
    void shouldRejectInvalidEnvelopeBeforePersistingEvidence() {
        ...
        assertThrows(IllegalArgumentException.class, () -> new KafkaOrderConfirmedEventConsumer(useCase).consume(record));
    }
}
