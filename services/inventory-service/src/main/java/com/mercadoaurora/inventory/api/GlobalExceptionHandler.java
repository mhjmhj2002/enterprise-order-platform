...
import com.mercadoaurora.inventory.api.dto.ApiErrorResponse;
...
import com.mercadoaurora.inventory.domain.DomainValidationException;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({InventoryItemNotFoundException.class, ReservationNotFoundException.class})
    ...
    public ResponseEntity<ApiErrorResponse> handleConflict(RuntimeException exception, HttpServletRequest request) {
        return buildErrorResponse(HttpStatus.CONFLICT, "INVENTORY_CONFLICT", exception.getMessage(), request);
    }
